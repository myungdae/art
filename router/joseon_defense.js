...
/* ─────────────────────────────────────────────────────────────
   온톨로지 로드 (서버 시작 시 1회)
   ───────────────────────────────────────────────────────────── */
const TTL_PATH = path.join(__dirname, "..", "data", "joseon_defense.ttl");
// 업로드 경로에서도 찾기
...
router.get("/", (req, res) => {
  ...
  res.render("joseon_defense/index", {
    pageTitle: "조선시대 국방 온톨로지",
    stats,
  });
});

// ── GET /joseon_defense/facet/:classKey ─────────────────────
router.get("/facet/:classKey", (req, res) => {
  ...
  res.render("joseon_defense/facet", {
...
// ── GET /joseon_defense/resource/:resourceId ────────────────
router.get("/resource/:resourceId", (req, res) => {
  ...
  res.render("joseon_defense/resource", {
